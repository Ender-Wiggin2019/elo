...
export abstract class Colony implements IColony {
  ...
  public visitor: undefined | IPlayer = undefined;
  ...
  // 殖民收入 贸易收入
  public giveBonus(player: IPlayer, bonusType: ColonyBenefit, quantity: number, resource: Resource | undefined, isGiveColonyBonus: boolean = false): undefined | PlayerInput {
