        ...
        <div id="game-setup-detail" class="game-setup-detail-container">
          <ul>
            ...
            <li><div v-if="gameOptions.rankTimeLimit" class="setup-item text-yellow-600" v-i18n>Rank Mode Time Limit:</div>
              <div class="game-config generic bg-yellow-600" v-i18n>{{gameOptions.rankTimeLimit + $t(' + every generation ') + gameOptions.rankTimePerGeneration + $t(' Min per Player')}}</div>
            </li>
