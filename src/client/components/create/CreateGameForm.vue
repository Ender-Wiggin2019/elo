      ...
      <div class="create-game-options">
        <div class="create-game-page-container">
          ...
          <div class="create-game-page-column">
            ...
            <input
              type="checkbox"
              name="allOfficialExpansions"
              id="allOfficialExpansions-checkbox"
            ...
            <input
              type="checkbox"
              name="breakthrough"
              id="breakthrough-checkbox"
              v-model="breakthrough"
              v-if="isvip"
            />
            <label
              for="breakthrough-checkbox"
              class="expansion-button"
              :class="{ forbidden: !isvip }"
            >
              <div class="create-game-expansion-icon expansion-icon-breakthrough"></div>
              <span v-i18n>BreakThrough</span>&nbsp;<a
                href="https://docs.qq.com/pdf/DS29QWFZLeUhWWlRR"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            <input
              type="checkbox"
              name="doubleCorp"
              id="doubleCorp-checkbox"
              v-model="doubleCorp"
              v-if="isvip"
            />
            <label
              for="doubleCorp-checkbox"
              class="expansion-button"
              :class="{ forbidden: !isvip }"
            >
            ...
            <input
              type="checkbox"
              name="eros"
              id="erosCards-checkbox"
              v-model="erosCardsOption"
              v-if="isvip"
            />
            <label
              for="erosCards-checkbox"
              class="expansion-button"
              :class="{ forbidden: !isvip }"
            >
              <div class="create-game-expansion-icon expansion-icon-eros"></div>
              <span v-i18n>Eros</span>&nbsp;<a
                href="http://blog.ender.lol/archives/eros"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            >
              ...
              <span v-i18n>Ares</span>&nbsp;<a
                href="https://docs.qq.com/pdf/DQVZqWU5BZURyUkZp"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            <input
              type="checkbox"
              name="community"
              id="communityCards-checkbox"
              v-model="communityCardsOption"
              v-if="isvip"
            />
            <label
              for="communityCards-checkbox"
              class="expansion-button"
              :class="{ forbidden: !isvip }"
            >
              <div class="create-game-expansion-icon expansion-icon-community"></div>
              <span v-i18n>Community</span>&nbsp;<a
                href="https://docs.qq.com/pdf/DQUFZaHdMWHl2V21M"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            <template v-if="turmoil">
              <input
                type="checkbox"
                name="politicalAgendas"
                id="politicalAgendas-checkbox"
                v-on:change="politicalAgendasExtensionToggle()"
                v-if="isvip"
              />
              <label
                for="politicalAgendas-checkbox"
                class="expansion-button"
                :class="{ forbidden: !isvip }"
              >
                <div class="create-game-expansion-icon expansion-icon-agendas"></div>
                <span v-i18n>Agendas</span>&nbsp;<a
                  href="https://docs.qq.com/doc/DQUh4RlJFQUxwb09v?pub=1&dver=2.1.0"
                  class="tooltip"
                  target="_blank"
                  >&#9432;</a
                >
              ...
              <div
                class="create-game-page-column-row"
                v-if="isPoliticalAgendasExtensionEnabled()"
              >
                <div>
                  <input
                    type="radio"
                    name="agendaStyle"
                    v-model="politicalAgendasExtension"
                    :value="getPoliticalAgendasExtensionAgendaStyle('random')"
                    id="randomAgendaStyle-radio"
                  />
                  <label
                    class="label-agendaStyle agendaStyle-random"
                    for="randomAgendaStyle-radio"
                  >
                    <span class="agendas-text" v-i18n>{{
                      getPoliticalAgendasExtensionAgendaStyle("random")
                    }}</span>
                  </label>
                </div>
                ...
                <div>
                  <input
                    ...
                    name="agendaStyle"
                    v-model="politicalAgendasExtension"
                    :value="getPoliticalAgendasExtensionAgendaStyle('chairman')"
                    id="chairmanAgendaStyle-radio"
                  />
                  <label
                    class="label-agendaStyle agendaStyle-chairman"
                    for="chairmanAgendaStyle-radio"
                  >
                    <span class="agendas-text" v-i18n>{{
                      getPoliticalAgendasExtensionAgendaStyle("chairman")
                    }}</span>
                  </label>
                </div>
              </div>
          ...
          <div class="create-game-page-column">
            ...
            <template v-for="boardName in boards">
              <div v-bind:key="boardName">
                <div
                  v-if="boardName === 'arabia terra'"
                  class="create-game-subsection-label"
                  :key="boardName + '-lab'"
                  v-i18n
                >
                  Fan-made
                ...
                <input
                  ...
                  name="board"
                  v-model="board"
                  :id="boardName + '-checkbox'"
                  :key="boardName"
                />
                <label
                  :for="boardName + '-checkbox'"
                  class="expansion-button"
                  :key="'-' + boardName"
                >
                  ...
                  <template
                    v-if="
                      boardName !== RandomBoardOption.OFFICIAL &&
                      boardName !== RandomBoardOption.ALL
                    "
                  >
                    &nbsp;<a :href="boardHref(boardName)" class="tooltip" target="_blank"
                      >&#9432;</a
                    >
                  </template>
                </label>
          ...
          <div class="create-game-page-column">
            ...
            <label for="startingCorpNum-checkbox">
              <input
                type="number"
                class="create-game-corporations-count"
                value="2"
                min="1"
                :max="6"
                v-model="startingCorporations"
                id="startingCorpNum-checkbox"
              />
            ...
            <label for="undo-checkbox"> <span v-i18n>Allow undo</span>&nbsp; </label>
            ...
            <input
              ...
              id="escapevelocity-checkbox"
            />
            <label for="escapevelocity-checkbox">
              <div
                class="create-game-expansion-icon expansion-icon-escape-velocity"
              ></div>
              <span v-i18n>Escape Velocity</span>&nbsp;<a
                href="https://github.com/terraforming-mars/terraforming-mars/wiki/Escape-Velocity"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            <label for="escapeThreshold-checkbox" v-show="escapeVelocityMode">
              ...
              <input
                ...
                min="0"
                :max="180"
                v-model="escapeVelocityThreshold"
                id="escapeThreshold-checkbox"
              />
            ...
            <label for="escapePeriod-checkbox" v-show="escapeVelocityMode">
              ...
              <input
                ...
                min="1"
                :max="10"
                v-model="escapeVelocityPenalty"
                id="escapePeriod-checkbox"
              />
            ...
            <input
              type="checkbox"
              v-model="showCorporationList"
              id="customCorps-checkbox"
            />
            ...
            <template v-if="prelude">
              <input
                type="checkbox"
                v-model="showPreludesList"
                id="customPreludes-checkbox"
                v-if="isvip"
              />
            ...
            <input
              type="checkbox"
              v-model="showBannedCards"
              id="bannedCards-checkbox"
              v-if="isvip"
            />
            ...
            <template v-if="turmoil">
              <input
                ...
                id="removeNegativeEvent-checkbox"
                v-if="isvip"
              />
          ...
          <div class="create-game-page-column" v-if="playersCount > 1">
            ...
            <div class="create-game-page-column-row">
              ...
              <div>
                <input
                  type="checkbox"
                  name="initialDraft"
                  v-model="initialDraft"
                  id="initialDraft-checkbox"
                />
            ...
            <label for="rankTimeLimit-checkbox" v-show="rankOption">
              ...
              <input
                ...
                min="0"
                :max="180"
                v-model="rankTimeLimit"
                id="rankTimeLimit-checkbox"
              />
            ...
            <label for="rankTimePerGeneration-checkbox" v-show="rankOption">
              ...
              <input
                ...
                min="10"
                :max="180"
                v-model="rankTimePerGeneration"
                id="rankTimePerGeneration-checkbox"
              />
            ...
            <div v-if="initialDraft && doubleCorp">
              <input
                type="checkbox"
                name="initialCorpDraftVariant"
                v-model="initialCorpDraftVariant"
            ...
            <input
              type="checkbox"
              v-model="randomFirstPlayer"
              id="randomFirstPlayer-checkbox"
            />
            ...
            <input
              type="checkbox"
              name="randomMAToggle"
              v-model="randomMACheckbox"
              id="randomMA-checkbox"
              v-on:change="randomMAToggle()"
              v-if="isvip"
            />
            ...
            <div class="create-game-page-column-row" v-if="false">
              <div>
                <input
                  ...
                  name="randomMAOption"
                  v-model="randomMA"
                  :value="getRandomMaOptionType('limited')"
              ...
              <div>
                <input
                  ...
                  name="randomMAOption"
                  v-model="randomMA"
                  :value="getRandomMaOptionType('full')"
            ...
            <input
              type="checkbox"
              name="showOtherPlayersVP"
              v-model="showOtherPlayersVP"
              id="realTimeVP-checkbox"
            />
            ...
            <label for="fastMode-checkbox"> <span v-i18n>Fast mode</span>&nbsp; </label>
          </div>
            ...
            <div class="container">
              <div class="columns">
                <template v-for="newPlayer in getPlayers()">
                  <div
                    :class="
                      'form-group col6 create-game-player ' +
                      getPlayerContainerColorClass(newPlayer.color)
                    "
                    :key="newPlayer.index"
                  >
                    <div>
                      <input
                        ...
                        :placeholder="getPlayerNamePlaceholder(newPlayer)"
                    ...
                    <div class="create-game-page-color-row">
                      ...
                      >
                        <input
                          ...
                          :name="'playerColor' + newPlayer.index"
                          v-model="newPlayer.color"
                          :id="'radioBox' + color + newPlayer.index"
                          :key="color"
                        />
                        <label
                          :for="'radioBox' + color + newPlayer.index"
                          :key="'_' + color"
                        >
                          <div
                            :class="
                              'create-game-colorbox ' + getPlayerCubeColorClass(color)
                            "
                          ></div>
                        </label>
                      </template>
          ...
          <div class="create-game-action">
            ...
            <span v-if="isvip">
              <label>
                <div class="btn btn-primary btn-action btn-lg">
                ...
                <input
                  ...
                  id="settings-file"
                  ref="file"
                  v-on:change="handleSettingsUpload()"
                />
              </label>

              <label>
                <div
                  v-on:click="downloadCurrentSettings()"
...
export default (Vue as WithRefs<Refs>).extend({
  ...
  methods: {
          ...
          try {
            ...
            if (typeof readerResults === 'string') {
              ...
              const customCorporations =
                results[json_constants.CUSTOM_CORPORATIONS] ||
                results[json_constants.OLD_CUSTOM_CORPORATIONS] ||
                [];
              const customColonies =
                results[json_constants.CUSTOM_COLONIES] ||
                results[json_constants.OLD_CUSTOM_COLONIES] ||
                [];
              const bannedCards =
                results[json_constants.BANNED_CARDS] ||
                results[json_constants.OLD_BANNED_CARDS] ||
                [];
    ...
    serializeSettings() {
      ...
      const rankTimePerGeneration = component.rankTimePerGeneration;
