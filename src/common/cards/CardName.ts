export enum CardName {
  ...
  _PRISTAR_ = 'Pristar (breakthrough)',
  ...
  RAINCAT_SCIENTIFIC_PROBE = '雩喵科学探测器',
  CITY_POWER_SHIFT = '🌸城电转能🌸',
  DUAL_ORBIT_LEAP = '🌸双轨跃迁🌸',
  FLORAL_BLOOM_SURGE = '🌸卉植繁茂🌸',
  UNIVERSAL_RESOURCE_CONVERTER = '🌸紧急回收站🌸',
  LAND_HARVEST = '🌸置地丰收🌸',
